...
function __promptline {
  ...
  local a_fg="${wrap}38;2;39;46;51${end_wrap}"
  local a_bg="${wrap}48;2;167;192;128${end_wrap}"
  local a_sep_fg="${wrap}38;2;167;192;128${end_wrap}"
  local c_fg="${wrap}38;2;133;146;137${end_wrap}"
  local c_bg="${wrap}48;2;46;56;60${end_wrap}"
  local c_sep_fg="${wrap}38;2;46;56;60${end_wrap}"
  local warn_fg="${wrap}38;2;39;46;51${end_wrap}"
  local warn_bg="${wrap}48;2;219;188;127${end_wrap}"
  local warn_sep_fg="${wrap}38;2;219;188;127${end_wrap}"
  local y_fg="${wrap}38;2;157;169;160${end_wrap}"
  local y_bg="${wrap}48;2;65;75;80${end_wrap}"
  local y_sep_fg="${wrap}38;2;65;75;80${end_wrap}"
  local z_fg="${wrap}38;2;39;46;51${end_wrap}"
  local z_bg="${wrap}48;2;167;192;128${end_wrap}"
  local z_sep_fg="${wrap}38;2;167;192;128${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
